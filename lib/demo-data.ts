  ...
  tiers: [
    {
      ...
      description: "Super early bird standard entry for one guest.",
      price_gbp: 75,
      capacity: 120,
      remaining: 120,
      max_per_order: 6,
    ...
    },
    {
      ...
      description: "Super early bird standard entry for two guests.",
      price_gbp: 145,
      capacity: 60,
      remaining: 60,
      max_per_order: 4,
    ...
    },
    {
      ...
      description: "Super early bird group booking for ten guests.",
      price_gbp: 700,
      capacity: 12,
      remaining: 12,
      max_per_order: 1,
